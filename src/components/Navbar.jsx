    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg ' >
      <div className='px-2 flex justify-between items-center w-full h-full' >
        ...
        <div className='md:hidden' >
          <MenuIcon className='w-[28px] ' onClick={handleToggleclick} />

        </div>
      </div>
      <div className={`${Toggleh ? "hidden" : ``} bg-zinc-200 transition duration-200 ease-linear `} >
        ...
        <div className='flex flex-col' >
          <Button text={`Login`} animition={`transition duration-300 hover:scale-105 ease-in   `} newstyle={` bg-transparent text-black py-2 `} />
          <Button text={`Sign up`} animition={`transition duration-300 hover:scale-105 ease-in  `} />
        </div>
      </div>
    </div>
